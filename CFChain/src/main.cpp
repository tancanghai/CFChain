...
int64 nChainStartTime = 1517504789;
...
const string strMessageMagic = "CFChain Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	{
        nSubsidy =5050000 * COIN;//1000 0000
	}
    else if(nHeight > 10 && nHeight <= 50000000)
    {
        nSubsidy =0.01 * COIN;//900 0000
    }
    else
    {
        nSubsidy =0 * COIN;//1500 0000
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CFChain
    bool fStrictPayToScriptHash = true; // Always active in CFChain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CFChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jan 11, 2018 ,Score accumulate for VIP members";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xd98086be733e006d7cc7b8cdf2c32b70fa1ff144b0fa575fde81377788245efd"));
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb2, 0xc7, 0xde };
